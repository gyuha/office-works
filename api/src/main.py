...
async def lifespan(application: FastAPI) -> AsyncGenerator[None, None]:
    ...
    logger.info("shutdown_complete", app="Office Works")
...
def _register_routers(application: FastAPI) -> None:
    ...
    # Org-settings domain
    try:
        from domains.org.router import router as org_router

        application.include_router(org_router, prefix="/api/v1")
        logger.debug("router_registered", prefix="/api/v1/positions")
    except ImportError:
        logger.debug("org_router_not_found", note="Will be added in later phase")
    ...
    try:
        ...
        logger.debug("router_registered", prefix="/api/v1/projects")
    except ImportError:
        logger.debug("projects_router_not_found", note="Will be added in later phase")
