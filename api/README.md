...
**Office Works** 은 FastAPI 기반의 Production-grade 백엔드 서버입니다.

- 생성 메타데이터: project slug `office-works`, public API base `http://localhost:8000`.
...
| `MAIL_FROM` | `noreply@office-works.example.com` | 발신 이메일 주소 |
